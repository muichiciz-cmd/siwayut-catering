...
<header class="h-[64px] bg-[#111113e6] border-b border-border flex items-center justify-between px-8 sticky top-0 z-40 backdrop-blur-[12px]">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <span class="text-xs text-gold bg-primary-light border border-[rgba(229,142,38,0.2)] px-2 py-0.5 rounded-full font-medium"><?= \App\Core\View::e($navUser['role'] === 'admin' ? __('admin') : __('user_role')) ?></span>
        </div>
        <?php endif; ?>
    </div>
</header>
